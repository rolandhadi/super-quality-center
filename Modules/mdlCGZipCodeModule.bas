...
Public Function ZipFolder(SourceFolderName, TargetZipFileName)
Dim oZip As New clsCGZipFiles
Dim FileFunct As New clsFiles
With oZip
    .ZipFileName = TargetZipFileName & ".zip"
    .UpdatingZip = False
    SourceFolderName = FileFunct.AddBackslash(CStr(SourceFolderName))
    .AddFile SourceFolderName & "*.xls*"
