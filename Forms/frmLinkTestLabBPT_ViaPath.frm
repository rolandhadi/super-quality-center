...
Begin VB.Form frmLinkTestLabBPT_ViaPath 
   Caption         =   "Link Test Plan to Test Lab Module"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   12645
   Icon            =   "frmLinkTestLabBPT_ViaPath.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   8595
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.CommandButton cmdUpload 
         ...
         Height          =   375
         Left            =   2880
         Picture         =   "frmLinkTestLabBPT_ViaPath.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdLoadExcel 
         ...
         Height          =   375
         Left            =   540
         Picture         =   "frmLinkTestLabBPT_ViaPath.frx":30EE
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Import step description and expected results from an excel file"
         Top             =   60
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":3894
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":3B26
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":3DB8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":4046
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":4758
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":4E6A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":557C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.StatusBar stsBar 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   670
            MinWidth        =   670
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":5C8E
         EndProperty
   ...
   Begin MSComctlLib.ImageList imgList_Sts 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":61DF
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":64C1
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":6A12
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestLabBPT_ViaPath.frx":6F63
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmLinkTestLabBPT_ViaPath"
...
Private Type TL_BPT
    ...
    Planned_Exec_Start_Date  As String
    Planned_Exec_End_Date As String
    Assigned_Group As String
    Log As String
End Type
...
For i = 1 To lastrow
    ...
    Else
        ...
        All_BPT(EndArr).Planned_Exec_Start_Date = flxImport.TextMatrix(i, 5)
        All_BPT(EndArr).Planned_Exec_End_Date = flxImport.TextMatrix(i, 6)
        All_BPT(EndArr).Assigned_Group = flxImport.TextMatrix(i, 7)
...
For i = LBound(All_BPT) To UBound(All_BPT)
    ...
    If All_BPT(i).Log = "" Then
        ...
        stsBar.Panels(1).Picture = imgList_Sts.ListImages(2).Picture: stsBar.Panels(2).Text = "Linking Test Lab - Test Plan " & i + 1 & " out of " & UBound(All_BPT) + 1 & " (" & All_BPT(i).Test_Lab_ID & "-" & All_BPT(i).Test_Plan_ID & ")"
...
mytsttestset.Field("TC_PLAN_SCHEDULING_DATE") = Format(tmp_BPT.Planned_Exec_Start_Date, "dd-mmm-yyyy")
mytsttestset.Field("TC_USER_TEMPLATE_03") = Format(tmp_BPT.Planned_Exec_End_Date, "dd-mmm-yyyy")
mytsttestset.Field("TC_USER_TEMPLATE_13") = tmp_BPT.Assigned_Group
mytsttestset.Field("TC_USER_TEMPLATE_10") = "000 Not Started"
mytsttestset.Post
...
'########################### Get Test Set Id bt Path ###########################
Public Function GetTestSetIDbyPath(strPath As String, strTestSet As String)
    Dim TestSetFact As TestSetFactory
...
' Get the test set folder.
    Set tSetFolder = tsTreeMgr.NodeByPath(strPath)
' Because we are searching for the full name,
' the list will have only one entry.
    Set TestSetsList = tSetFolder.FindTestSets(strTestSet)
    Set theTestSet = TestSetsList.Item(1)
    GetTestSetIDbyPath = theTestSet.ID
Exit Function
Err1:
    GetTestSetIDbyPath = 0
End Function

'########################### End Of Get Test Set Id bt Path ###########################
...
If Err.Number = 91 Then
    MsgBox "Please select a folder in the Test Lab tree folder"
    Exit Sub
End If
On Error GoTo 0
        ...
        If chkOnlyID.Value = Checked Then
            For i = 2 To lastrow
                ...
                If Trim(.Range("A" & i).Value) = "" Then
                    flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[Test Set ID=BLANK]"
                    tmpSts = tmpSts + 1
                End If
                flxImport.TextMatrix(i - 1, 1) = CleanTheString(Trim((.Range("B" & i).Value)))         'Change number and letter
                If Trim(.Range("B" & i).Value) = "" Then
                    flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[Test ID=BLANK]"
                    tmpSts = tmpSts + 1
                End If
            Next
        Else
            For i = 2 To lastrow
                ...
                If Trim(.Range("D" & i).Value) = "" Then
                    flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[Test Set Name=BLANK]"
                    tmpSts = tmpSts + 1
                End If
                
                flxImport.TextMatrix(i - 1, 2) = FileFunct.RemoveBackslash(Trim((.Range("C" & i).Value)))          'Change number and letter
                If Trim(.Range("C" & i).Value) = "" Then
                    flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[Test Set Path=BLANK]"
                    tmpSts = tmpSts + 1
                Else
                    strFolderID = GetTestSetIDbyPath(flxImport.TextMatrix(i - 1, 2), flxImport.TextMatrix(i - 1, 3))
                    If strFolderID = 0 Then
                      flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[TEST SET N/A]"
                      tmpSts = tmpSts + 1
                    Else
                      flxImport.TextMatrix(i - 1, 0) = strFolderID
                    End If
                End If
                
                flxImport.TextMatrix(i - 1, 4) = CleanTheString(Trim((.Range("E" & i).Value)))        'Change number and letter
                ...
                Else
                    ...
                    objCommand.CommandText = "SELECT TS_TEST_ID FROM TEST, ALL_LISTS WHERE TS_SUBJECT = AL_ITEM_ID AND " & strPath & " AND TS_NAME = '" & Trim(flxImport.TextMatrix(i - 1, 4)) & "'"
                    ...
                    ElseIf rs.RecordCount > 1 Then
                        flxImport.TextMatrix(i - 1, 1) = rs.FieldValue("TS_TEST_ID")
                        flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[MULTIPLE TEST (" & rs.RecordCount & "]"
                        tmpSts = tmpSts + 1
                    Else
                        flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[TEST N/A]"
                        tmpSts = tmpSts + 1
                    End If
                End If
                flxImport.TextMatrix(i - 1, 5) = Format((Trim((.Range("F" & i).Value))), "dd-mmm-yyyy")          'Change number and letter
                flxImport.TextMatrix(i - 1, 6) = Format((Trim((.Range("G" & i).Value))), "dd-mmm-yyyy")            'Change number and letter
                If Trim(.Range("H" & i).Value) = "" Then
                    'flxImport.TextMatrix(i - 1, 8) = flxImport.TextMatrix(i - 1, 8) & "[Assigned Group=BLANK]"
                    'tmpSts = tmpSts + 1
                Else
                    flxImport.TextMatrix(i - 1, 7) = Trim(.Range("H" & i).Value)       'Change number and lette
                End If
...
QCTree_TP.width = Me.width - QCTree_TP.Left - 350
End Sub
...
flxImport.TextMatrix(0, 2) = "Test Set Path (TEST LAB)"
flxImport.TextMatrix(0, 3) = "Test Set Name (TEST LAB)"
flxImport.TextMatrix(0, 4) = "Test Name (TEST PLAN)"
flxImport.TextMatrix(0, 5) = "Planned Exec Start Date"
flxImport.TextMatrix(0, 6) = "Planned Exec End Date"
flxImport.TextMatrix(0, 7) = "Assigned Group"
...
Public Function IncorrectHeaderDetails() As Boolean
    ...
    If flxImport.TextMatrix(0, 2) <> "Test Set Path (TEST LAB)" Then IncorrectHeaderDetails = True
    If flxImport.TextMatrix(0, 3) <> "Test Set Name (TEST LAB)" Then IncorrectHeaderDetails = True
    If flxImport.TextMatrix(0, 4) <> "Test Name (TEST PLAN)" Then IncorrectHeaderDetails = True
    If flxImport.TextMatrix(0, 5) <> "Planned Exec Start Date" Then IncorrectHeaderDetails = True
    If flxImport.TextMatrix(0, 6) <> "Planned Exec End Date" Then IncorrectHeaderDetails = True
    If flxImport.TextMatrix(0, 7) <> "Assigned Group" Then IncorrectHeaderDetails = True
...
'On Error Resume Next
    ...
    'xlObject.Sheets(curTab).Protection.AllowEditRanges.Add Title:="Range1", Range:=xlObject.Sheets(curTab).Range("C:E")
