...
Begin VB.Form frmLinkTestPlanReq 
   Caption         =   "Link Requirement to Test Plan Module"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmLinkTestPlanReq.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   8595
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin VB.CommandButton cmdUpload 
         ...
         Height          =   375
         Left            =   2880
         Picture         =   "frmLinkTestPlanReq.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdLoadExcel 
         ...
         Height          =   375
         Left            =   540
         Picture         =   "frmLinkTestPlanReq.frx":30EE
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Import step description and expected results from an excel file"
         Top             =   60
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":3894
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":3B26
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":3DB8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":4046
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":4758
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":4E6A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":557C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.StatusBar stsBar 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   670
            MinWidth        =   670
            Picture         =   "frmLinkTestPlanReq.frx":5C8E
         EndProperty
   ...
   Begin MSComctlLib.ImageList imgList_Sts 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":61DF
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":64C1
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":6A12
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLinkTestPlanReq.frx":6F63
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmLinkTestPlanReq"
...
For i = LBound(All_REQ) To UBound(All_REQ)
    ...
    If All_REQ(i).Log = "" Then
        Call LinkReqTest(All_REQ(i))
        stsBar.Panels(1).Picture = imgList_Sts.ListImages(2).Picture: stsBar.Panels(2).Text = "Linking Test Plan - Requirement " & i + 1 & " out of " & UBound(All_REQ) + 1 & " (" & All_REQ(i).Test_Plan_ID & "-" & All_REQ(i).Req_ID & ")"
        If Err.Number <> 0 Then
            FileAppend App.path & "\SQC Logs" & "\" & Format(Now, "mm-dd-yyyy") & ".log", "[LINK BC: (FAILED) " & Now & " " & All_REQ(i).Test_Plan_ID & "-" & All_REQ(i).Req_ID & "] " & Err.Description
            HasUploadIssue = HasUploadIssue + 1
        Else
            FileAppend App.path & "\SQC Logs" & "\" & Format(Now, "mm-dd-yyyy") & ".log", "[LINK BC: (PASSED) " & Now & " " & All_REQ(i).Test_Plan_ID & "-" & All_REQ(i).Req_ID & "]"
        End If
    Else
        FileAppend App.path & "\SQC Logs" & "\" & Format(Now, "mm-dd-yyyy") & ".log", "[LINK BC: (SKIPPED) " & Now & " " & All_REQ(i).Test_Plan_ID & "-" & All_REQ(i).Req_ID & "]"
    End If
    Err.Clear
    On Error GoTo 0
...
stsBar.Panels(1).Picture = imgList_Sts.ListImages(1).Picture: stsBar.Panels(2).Text = UBound(All_REQ) + 1 & " Test Plan - Requirement linked successfully. (" & HasUploadIssue & ") uploading issue(s) found. See " & App.path & "\SQC DAT" & "\" & Format(Now, "mm-dd-yyyy") & ".log"
QCConnection.SendMail "user@companyemail.com", "", "[HPQC UPDATES] Test Plan - Requirement linked successfully by " & curUser & " in " & curDomain & "-" & curProject, UBound(All_REQ) + 1 & " Test Plan - Requirement linked successfully. (" & HasUploadIssue & ") uploading issue(s) found. See " & App.path & "\SQC DAT" & "\" & Format(Now, "mm-dd-yyyy") & ".log" & "<br><br>" & "Source Data FileName: " & dlgOpenExcel.filename, "", "HTML"
QCConnection.SendMail curUser, "", "[HPQC UPDATES] Test Plan - Requirement linked successfully by " & curUser & " in " & curDomain & "-" & curProject, UBound(All_REQ) + 1 & " Test Plan - Requirement linked successfully. (" & HasUploadIssue & ") uploading issue(s) found. See " & App.path & "\SQC DAT" & "\" & Format(Now, "mm-dd-yyyy") & ".log" & "<br><br>" & "Source Data FileName: " & dlgOpenExcel.filename, "", "HTML"
...
Private Sub LinkReqTest(tmp_REQ As RQ_TP)
Dim coverable As ICoverableReq
Dim reqF As ReqFactory
Dim aReq As Req
Set reqF = QCConnection.ReqFactory
Set aReq = reqF.Item(tmp_REQ.Req_ID)
Set coverable = aReq
coverable.AddTestToCoverage tmp_REQ.Test_Plan_ID
...
'On Error Resume Next
  ...
  xlObject.Workbooks(1).SaveAs "RQ_LINKTP-01" & "-" & Format(Now, "mmddyyyy HHMMSS AMPM")
  xlObject.Visible = True
